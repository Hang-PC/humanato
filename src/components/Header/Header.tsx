...
const Header = (props: Props) => {
  ...
  return (
    <motion.ul animate={{ y: 10 }}>
      <nav className="bg-gray-900/70 backdrop-blur-md text-white absolute top-5 left-1/2 transform -translate-x-1/2 w-6/12 rounded-full shadow-lg z-50 border border-gray-300/10 pe-3">
